...
public class BytePlusModelArkClient
{
    ...
    public BytePlusModelArkClient(HttpClient httpClient, ILogger<BytePlusModelArkClient> logger, string apiKey, string baseUrl = "https://ark.ap-southeast.bytepluses.com")
    {
    ...
    public async Task<BytePlusVideoTaskResponse> CreateVideoGenerationTaskAsync(string prompt, string? imageUrl = null, VideoGenerationOptions? options = null)
    {
    ...
    private string BuildPromptWithParameters(string prompt, VideoGenerationOptions? options)
    {
